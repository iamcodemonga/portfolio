            ...
            <div className="row gx-5">
                <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                    ...
                    <div className="mt-3 mb-5">
                        <a className="me-4" href="https://linkedin.com/in/codemonga" style={{color: '#0072b1'}} target="_blank">
                        ...
                        <a className="me-4" href="https://twitter.com/codemonga" style={{color: '#00acee'}} target="_blank">
                        ...
                        <a className="me-4" href="https://github.com/iamcodemonga" target="_blank">
                        ...
                        <a className="me-4" href="https://www.instagram.com/codemonga/" style={{color: '#d62976'}} target="_blank">
                        ...
                        <a className="me-4" href="https://tiktok.com/@codemonga" style={{color: '#00f2ea'}}>
